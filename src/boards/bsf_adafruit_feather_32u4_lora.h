/*******************************************************************************
 * 
 *  File:         bsf_adafruit_feather_32u4_lora.h
 * 
 *  Function:     Board Support File for Adafruit LoRa32u4 II versions 1.0 to 1.3.
 * 
 ...
 * 
 *  Docs:         https://docs.platformio.org/en/latest/boards/atmelavr/adafruit_feather_32u4_lora.html
 *
 *  Identifiers:   LMIC-node
 *                     board-id:      adafruit_feather_32u4_lora
 *                 PlatformIO
 *                     board:         adafruit_feather_32u4_lora
 *                     platform:      atmelavr
 *                 Arduino
...
#ifndef BSF_adafruit_feather_32u4_lora_H_
#define BSF_adafruit_feather_32u4_lora_H_

#include "LMIC-node.h"

#define DEVICEID_DEFAULT "adafruit_feather_32u4_lora"  // Default deviceid value
...
const lmic_pinmap lmic_pins = {
    ...
    .rst = 4,
    .dio = { /*dio0*/ 7, /*dio1*/ 6, /*dio2*/ LMIC_UNUSED_PIN }
#ifdef MCCI_LMIC
    ,
    .rxtx_rx_active = 0,
    .rssi_cal = 8,
...
#endif  // BSF_adafruit_feather_32u4_lora_H_